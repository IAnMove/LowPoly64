...
const translations = {
  ...
  pngModelTitle: { en: 'PNG TO VOLUMETRIC MODEL', es: 'PNG A MODELO CON VOLUMEN' },
  pngModelTryFish: { en: 'TRY REEF FISH', es: 'PROBAR PEZ DE ARRECIFE' },
  pngModelResetMap: { en: 'RESET MAP', es: 'REINICIAR MAPA' },
  pngModelViewFront: { en: 'FRONT', es: 'FRONTAL' },
  pngModelViewSide: { en: 'SIDE', es: 'LATERAL' },
  pngModelRegenerate: { en: 'REGENERATE', es: 'REGENERAR' },
  pngModelClose: { en: 'CLOSE', es: 'CERRAR' },
  pngModelDiscardConfirm: {
    en: 'Discard the unsaved PNG model changes?',
    es: '¿Descartar los cambios sin guardar del modelo PNG?',
  },
  pngModelCreate: { en: 'CREATE MODEL', es: 'CREAR MODELO' },
  pngModelUpdate: { en: 'UPDATE MODEL', es: 'ACTUALIZAR MODELO' },
  pngModelCreateSubtitle: {
    en: 'Transparent image to editable 2.5D volume',
    es: 'Imagen transparente a volumen 2.5D editable',
  },
  pngModelEditSubtitle: {
    en: 'Regenerate selected PNG model',
    es: 'Regenerar el modelo PNG seleccionado',
  },
  ...
  avatarFullFaceCustomNote: { en: 'Loose eyes, brows and mouth remain independently editable.', es: 'Ojos, cejas y boca siguen siendo editables por separado.' },
  avatarFullFaceTransparentNote: { en: 'Recommended: transparent facial features inherit the selected skin color.', es: 'Recomendado: los rasgos transparentes heredan el color de piel elegido.' },
  avatarFullFaceSkinPlateNote: { en: 'Skin plate: includes a baked skin color and may not match every palette.', es: 'Placa de piel: incluye un color horneado y puede no coincidir con todas las paletas.' },
  ...
  avatarMoldModeNote: { en: 'New sessions use generated skulls as the canonical head system.', es: 'Las sesiones nuevas usan craneos generados como sistema canonico de cabeza.' },
  ...
  avatarStarterHeroes: { en: 'STARTER HEROES', es: 'HÉROES INICIALES' },
  avatarTurntable: { en: 'TURNTABLE', es: 'GIRATORIO' },
  avatarDiceBody: { en: 'Randomize body and head', es: 'Aleatorio: cuerpo y cabeza' },
  avatarDiceFace: { en: 'Randomize face', es: 'Aleatorio: cara' },
  avatarDiceExtras: { en: 'Randomize hair and extras', es: 'Aleatorio: pelo y extras' },
  avatarDiceColors: { en: 'Randomize colors', es: 'Aleatorio: colores' },
  avatarCopyRecipe: { en: 'COPY RECIPE', es: 'COPIAR RECETA' },
  avatarRecipeCopied: { en: 'Recipe JSON copied to clipboard', es: 'Receta JSON copiada al portapapeles' },
  avatarRecipeCopyFailed: { en: 'Clipboard unavailable', es: 'Portapapeles no disponible' },
  ...
  avatarHeadMigratedToast: { en: 'Head migrated to the new system', es: 'cabeza migrada al nuevo sistema' },
  ...
  standardClipLibrary: { en: 'LIBRARY CLIP', es: 'CLIP DE LIBRERIA' },
  standardClipLibraryReady: { en: '{count} library clips ready for this standard rig.', es: '{count} clips de libreria listos para este rig estandar.' },
  standardClipApplied: { en: 'Library clip "{name}" applied.', es: 'Clip de libreria "{name}" aplicado.' },
  standardClipMissing: { en: 'Selected library clip was not found.', es: 'No se encontro el clip de libreria seleccionado.' },
  standardClipNoTracks: { en: 'The selected library clip has no tracks for this rig.', es: 'El clip de libreria seleccionado no tiene tracks para este rig.' },
  ...
  motionRipperHalfBodyBadge: { en: 'HALF BODY DETECTED', es: 'MEDIO CUERPO DETECTADO' },
  motionRipperFreezeLowerBodyHintDetected: { en: 'Lower-body coverage looks incomplete. Keeping the legs in idle is recommended for this take.', es: 'La parte inferior se ve incompleta. Se recomienda mantener las piernas en idle para esta toma.' },
  motionRipperFreezeLowerBodyHintIdle: { en: 'If the clip is torso-up or the legs jitter, enable this to keep the lower body in idle.', es: 'Si el clip es torso-arriba o las piernas vibran, activa esto para dejar el tren inferior en idle.' },
