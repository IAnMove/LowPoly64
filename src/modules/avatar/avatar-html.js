        ...
        <div class="flex flex-1 min-h-0 overflow-hidden">
          <div class="w-[46%] min-w-0 border-r border-zinc-700 overflow-y-auto p-4 space-y-4">
            <div class="grid grid-cols-2 gap-3">
              ...
              <div class="col-span-2 flex items-start justify-between gap-3 rounded border border-zinc-700 bg-zinc-950 px-3 py-2">
                <div class="min-w-0">
            ...
            <div>
              <div class="flex items-center justify-between gap-3 mb-2">
                <div class="text-zinc-500 text-[8px]" data-i18n="avatarFeaturePlacement">FEATURE PLACEMENT</div>
                <div id="avatar-feature-controls-note" class="text-right text-[8px] leading-relaxed text-zinc-500"></div>
              </div>
              <div id="avatar-feature-controls" class="grid grid-cols-2 gap-3"></div>
            </div>
