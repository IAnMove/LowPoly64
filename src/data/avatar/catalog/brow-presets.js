const BROW_SPRITE_BY_PRESET_ID = Object.freeze({
  ...
  image2_hero_flat_01: 'brow_image2_hero_flat',
  image2_raised_curve_01: 'brow_image2_raised_curve',
  image2_angry_slash_01: 'brow_image2_angry_slash',
  image2_sad_inner_01: 'brow_image2_sad_inner',
  image2_noble_arch_01: 'brow_image2_noble_arch',
  image2_elder_bushy_01: 'brow_image2_elder_bushy',
  image2_villain_hook_01: 'brow_image2_villain_hook',
  image2_panic_high_01: 'brow_image2_panic_high',
  image2_child_soft_01: 'brow_image2_child_soft',
...
export const AVATAR_BROW_PRESETS = Object.freeze([
  ...
  { id: 'image2_hero_flat_01', label: 'Image2 Hero Flat', labels: Object.freeze({ en: 'Image2 Hero Flat', es: 'Heroe plana Image2' }), markup: '' },
  { id: 'image2_raised_curve_01', label: 'Image2 Raised Curve', labels: Object.freeze({ en: 'Image2 Raised Curve', es: 'Curva alzada Image2' }), markup: '' },
  { id: 'image2_angry_slash_01', label: 'Image2 Angry Slash', labels: Object.freeze({ en: 'Image2 Angry Slash', es: 'Corte enfadado Image2' }), markup: '' },
  { id: 'image2_sad_inner_01', label: 'Image2 Sad Inner', labels: Object.freeze({ en: 'Image2 Sad Inner', es: 'Triste interior Image2' }), markup: '' },
  { id: 'image2_noble_arch_01', label: 'Image2 Noble Arch', labels: Object.freeze({ en: 'Image2 Noble Arch', es: 'Arco noble Image2' }), markup: '' },
  { id: 'image2_elder_bushy_01', label: 'Image2 Elder Bushy', labels: Object.freeze({ en: 'Image2 Elder Bushy', es: 'Anciana poblada Image2' }), markup: '' },
  { id: 'image2_villain_hook_01', label: 'Image2 Villain Hook', labels: Object.freeze({ en: 'Image2 Villain Hook', es: 'Gancho villano Image2' }), markup: '' },
  { id: 'image2_panic_high_01', label: 'Image2 Panic High', labels: Object.freeze({ en: 'Image2 Panic High', es: 'Panico alta Image2' }), markup: '' },
  { id: 'image2_child_soft_01', label: 'Image2 Child Soft', labels: Object.freeze({ en: 'Image2 Child Soft', es: 'Nino suave Image2' }), markup: '' },
