...
**Pasos:** [DELEGABLE] andamiaje: tabla de specs + registro en el catálogo
(`src/data/avatar/catalog/head-molds.js`) con ids nuevos `gen_head_*`.
[FABLE] el ajuste fino de cada preset mirando capturas (2–3 iteraciones).
