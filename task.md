...
- [ ] 2.10 Mejorar los cuerpos: varios moldes de cuerpo nuevos con buen look PSX/N64 (p. ej. chibi, héroe esbelto, robusto), con proporciones y siluetas low-poly cuidadas para que el avatar completo dé el pego, no solo la cabeza. Pedido del usuario (2026-06-10), a abordar después del pelo (2.4).
